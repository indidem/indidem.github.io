...
However, to safeguard the privacy of those included in the database, *all people who have no death date recorded* in Shirley's database have been somewhat de-identified: for each, their first names have been replaced with the marker *[Living]*, plus dates and most notes have been removed. Connections to other family members, and any details contained in the notes of a deceased person, have been retained.

This way of publishing the data has been adopted to meet the spirit of the European [General Data Protection Regulation](https://gdpr.eu/what-is-gdpr/) (GDPR). [Historical research](https://gdpr.eu/article-89-processing-for-archiving-purposes-scientific-or-historical-research-purposes-or-statistical-purposes/) and [archives](https://gdpr.eu/Recital-158-Processing-for-archiving-purposes/), including genealogy records, are largely exempt from GDPR law, which requires informed consent for data collection among other things.
...
Please also note the future direction for this data is to be transferred, in part or whole, to the Wikitree network. Wikitree has been chosen for several reasons, and one significant reason is the strength of their [privacy controls](https://www.wikitree.com/wiki/Help:Privacy) and sensitivity of such issues.
