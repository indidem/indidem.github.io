...
* There is no built-in search for the whole database however you can search the text on each page: press Ctrl+F on your keyboard to open the Find box (for instructions on this, visit [Wikihow](https://www.wikihow.com/Search-for-a-Word-on-a-Webpage)).
